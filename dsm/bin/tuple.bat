...
set DSMCLASS=com.ibm.watson.dsm.engine.app.TupleAdmin
...
REM Do the actual work and pick a JCS port that hopefully is not being used !
dsmrun %DSMCLASS% "-Djcs.auxiliary.LTCP.attributes.TcpListenerPort=2222"  %*
